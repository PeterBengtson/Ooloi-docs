...
If a window ever opens empty and is right only after being closed and reopened, this is the first thing to check: a watch installed after the value arrived never fires for it, because `add-watch` reports subsequent changes and nothing else.
