...
- [Paradigm Shift: Musical Time as Computational Foundation](#paradigm-shift-musical-time-as-computational-foundation)
  - [The Core Transformation: Piece → Stream](#the-core-transformation-piece--stream)
  - [From Imperative to Temporal-Functional](#from-imperative-to-temporal-functional)
...
- [Transducer Architecture Decision](#transducer-architecture-decision)
  - [Why Clojure Transducers?](#why-clojure-transducers)
  - [Alternative Approaches Considered and Rejected](#alternative-approaches-considered-and-rejected)
  - [Single Unified Transducer Architecture](#single-unified-transducer-architecture)
  - [Transducer-Specific Advantages for Musical Applications](#transducer-specific-advantages-for-musical-applications)
- [Detailed Design](#detailed-design)
  - [1. Core Algorithm: Temporal Breadth-First Traversal](#1-core-algorithm-temporal-breadth-first-traversal)
  - [2. Boundary-VPD Scope Limiting](#2-boundary-vpd-scope-limiting)
  - [3. Transducer Integration Examples](#3-transducer-integration-examples)
  - [4. Deep Traversal Support](#4-deep-traversal-support)
  - [5. Grace Note Position Semantics](#5-grace-note-position-semantics)
- [Key Applications](#key-applications)
  - [Cross-Domain Pattern Unification](#cross-domain-pattern-unification)
  - [1. MIDI Playback Generation](#1-midi-playback-generation)
  - [2. Visual Layout Calculation](#2-visual-layout-calculation)
  - [3. Attachment Resolution](#3-attachment-resolution)
  - [4. Collaborative Editing](#4-collaborative-editing)
  - [5. Analysis and Export](#5-analysis-and-export)
- [Rationale](#rationale)
