...
- [Rationale](#rationale)
  ...
  - [Why Host Control Over External MIDI](#why-host-control-over-external-midi)
...
- [Success Criteria](#success-criteria)
  ...
  - [Ecosystem Goals](#ecosystem-goals)
- [Future Extensions](#future-extensions)
- [Related Guides](#related-guides)
- [Conclusion](#conclusion)
- [Appendix A: Vendor Control Surface Research](#appendix-a-vendor-control-surface-research)
  - [VST3-Specific Interfaces](#vst3-specific-interfaces)
  - [Spitfire Audio (BBCSO, Abbey Road, Symphonic)](#spitfire-audio-bbcso-abbey-road-symphonic)
  - [Orchestral Tools (SINE)](#orchestral-tools-sine)
  - [Vienna Symphonic Library (Synchron Player)](#vienna-symphonic-library-synchron-player)
  - [EastWest (Opus)](#eastwest-opus)
  - [Audio Modeling (SWAM)](#audio-modeling-swam)
  - [SFZ Players (VPO, etc.)](#sfz-players-vpo-etc)
...
- [ADR-0044: MIDI Input Library and Boundary Architecture](0044-MIDI-Input-Library-and-Boundary-Architecture.md) — Confirms that MIDI output is rejected for the core input subsystem; plugin extension point for MIDI output described
