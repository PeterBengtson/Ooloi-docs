...
- [Context](#context)
  ...
  - [Cognitive Load Considerations](#cognitive-load-considerations)
- [Decision](#decision)
  - [1. Unified Protobuf Schema](#1-unified-protobuf-schema)
  - [2. Dynamic API Method Resolution](#2-dynamic-api-method-resolution)
  - [3. Server-to-Client Event Notification Architecture](#3-server-to-client-event-notification-architecture)
  - [4. Service Architecture](#4-service-architecture)
- [Rationale](#rationale)
  - [Scale and Maintenance](#scale-and-maintenance)
...
- [Implementation Approach](#implementation-approach)
  - [1. Unified Conversion System (Replaces Code Generation)](#1-unified-conversion-system-replaces-code-generation)
  - [2. Bidirectional Communication Infrastructure](#2-bidirectional-communication-infrastructure)
  - [3. Integration with Component Architecture](#3-integration-with-component-architecture)
- [Alternatives Considered](#alternatives-considered)
  - [1. Manual gRPC Implementation](#1-manual-grpc-implementation)
  - [2. Selective API Exposure](#2-selective-api-exposure)
  - [3. Synchronous-Only Communication](#3-synchronous-only-communication)
  - [4. Service Layer Abstraction](#4-service-layer-abstraction)
  - [5. Object-Based gRPC Interface](#5-object-based-grpc-interface)
...
- [ADR-0052: Change Detection and Event Generation](0052-Change-Detection-and-Event-Generation.md) - The backend mechanism producing piece events through this interface: detection at the VPD write funnel, a structural trait emitting `:piece-structure-changed`, and agent-deferred emission coalesced to one event per transaction
