...
- **[0045-Instrument-Library](0045-Instrument-Library.md)**: Server-side singleton instrument template registry with optimistic locking, lazy frontend caching, event-driven synchronisation, and a bundled library covering the full orchestral repertoire from Bach to Messiaen
