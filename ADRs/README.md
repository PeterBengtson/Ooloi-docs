...
| **Audio Architecture** | [0027](0027-Plugin-Based-Audio-Architecture.md), [0041](0041-Ooloi-Virtual-Instrument-Definition-OVID.md) | Frontend plugin-based audio processing, complete backend-frontend audio separation, YAML-based virtual instrument definition with canonical taxonomy and calibration |
