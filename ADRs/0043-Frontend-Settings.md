...
- [Rationale](#rationale)
  - [Single Source of Truth for Defaults](#single-source-of-truth-for-defaults)
  - [Lazy Loading Eliminates Ordering Dependencies](#lazy-loading-eliminates-ordering-dependencies)
  - [Separation from Backend Settings](#separation-from-backend-settings)
  - [Atom Over Integrant Component](#atom-over-integrant-component)
  - [Validation Pattern Consistency](#validation-pattern-consistency)
  - [Translation Key Convention](#translation-key-convention)
- [Implementation](#implementation)
- [Testing Settings-Dependent Code](#testing-settings-dependent-code)
  - [with-frontend-test-config — the Primary Wrapper](#with-frontend-test-config--the-primary-wrapper)
  - [default-settings — Registry-Derived Defaults](#default-settings--registry-derived-defaults)
  - [with-event-bus — Tests That Publish Setting Events](#with-event-bus--tests-that-publish-setting-events)
- [Consequences](#consequences)
  - [Positive](#positive)
  - [Negative](#negative)
  - [Mitigations](#mitigations)
- [Alternatives Considered](#alternatives-considered)
  - [Integrant Component](#integrant-component)
  - [Extend ADR-0016 (Backend Settings)](#extend-adr-0016-backend-settings)
  - [Property Files or JSON](#property-files-or-json)
  - [Defaults in Separate Resource File](#defaults-in-separate-resource-file)
  - [Explicit Startup Init](#explicit-startup-init)
...
Tests that only call `get-app-setting` do not need `with-event-bus`.
