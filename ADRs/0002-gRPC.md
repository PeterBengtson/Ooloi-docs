...
4. Application logic calls `register-for-events` when ready to establish connections (e.g., after UI initialization)
...
4. Application logic calls `register-for-events` when ready to connect to backend server over network
