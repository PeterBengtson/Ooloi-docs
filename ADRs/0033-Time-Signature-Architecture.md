...
**Common time:**
```clojure
(create-time-signature :descriptor "4/4")
=> {:descriptor "4/4"
    :groups [{:count [4] :duration 1/4}]
    :duration 1}
```
...
**Additive meter:**
```clojure
(create-time-signature :descriptor "2+3/8")
=> {:descriptor "2+3/8"
    :groups [{:count [2 3] :duration 1/8}]
    :duration 5/8}
```

**Fractional decimal:**
```clojure
(create-time-signature :descriptor "2.5/4")
=> {:descriptor "2.5/4"
    :groups [{:count [[5/2 "2.5"]] :duration 1/4}]
    :duration 5/8}
```
...
**Fractional Unicode:**
```clojure
(create-time-signature :descriptor "2½/4")
=> {:descriptor "2½/4"
    :groups [{:count [[5/2 "2½"]] :duration 1/4}]
    :duration 5/8}
```

**Mixed fractional and integer:**
```clojure
(create-time-signature :descriptor "1.5+2½+3/4")
...
**Multiple groups:**
```clojure
(create-time-signature :descriptor "2/4+3/8")
=> {:descriptor "2/4+3/8"
    :groups [{:count [2] :duration 1/4}
             {:count [3] :duration 1/8}]
    :duration 7/8}
...
**Dotted unit (Orff):**
```clojure
(create-time-signature :descriptor "4/4." :unit-form :note)
=> {:descriptor "4/4."
    :groups [{:count [4] :duration [1/4 1]}]
    :duration 3/2
    :unit-form :note}
```

**With alternate descriptor:**
```clojure
(create-time-signature :descriptor "6/8"
                      :alternate-descriptor "3/4")
=> {:descriptor "6/8"
    :alternate-descriptor "3/4"
    :groups [{:count [6] :duration 1/8}]
    :alternate-groups [{:count [3] :duration 1/4}]
    :duration 3/4}
```
