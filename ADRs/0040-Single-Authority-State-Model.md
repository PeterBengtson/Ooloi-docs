...
- [Alternatives Considered](#alternatives-considered)
  - [1. Wholesale Piece Transfer](#1-wholesale-piece-transfer)
  - [2. Dual State with Reconciliation](#2-dual-state-with-reconciliation)
  - [3. Zero-Latency Editing via Local State](#3-zero-latency-editing-via-local-state)
  - [4. Operation Queueing for Offline Support](#4-operation-queueing-for-offline-support)
